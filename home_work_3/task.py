...
#I used ... .__contains__('...') for find keywords.
...
while True:
    ...
    elif user_input.__contains__('How are you doing') or  user_input.__contains__('What are you doing'):
    ...
    elif user_input.__contains__('Thank') or user_input.__contains__('thank'):
